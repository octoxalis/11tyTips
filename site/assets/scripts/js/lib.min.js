...
const DOM_locationKey__s = () =>
{
  ...
  const key_s = location_s.slice( location_s.lastIndexOf( 'tip'), -extension_n )
  return key_s
}
/**
...
const linkNearShow__v = ( event_s, link_e ) =>
{
  ...
  if ( event_s === 'mouseenter' )
  {
    ...
    else
    {
      ...
      `<a href="./${near_o.link_s}.html">${near_o.title_s} ⤴</a>`    //:`<a href="https://11tytips.netlify.com/${near_o.link_s}.html">${near_o.title_s} ⤴</a>`
...
//: Register service worker
        ...
        if ( 'serviceWorker' in navigator ) window
          .addEventListener( 'load', service__v( 'https://11tytips.netlify.com/assets/scripts/js/service_worker.min.js' ) )
